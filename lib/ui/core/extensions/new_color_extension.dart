...
// Extension para facilitar o acesso às cores no BuildContext
extension NewAppColorThemeExtension on BuildContext {
  NewAppColorTheme get newColors => Theme.of(this).extension<NewAppColorTheme>()!;
}
